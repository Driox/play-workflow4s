...
public class CustomPostgresBinaryResolver implements  PgBinaryResolver {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CustomPostgresBinaryResolver.class);

    public static final CustomPostgresBinaryResolver INSTANCE = new CustomPostgresBinaryResolver();

    private CustomPostgresBinaryResolver() {}
    ...
    private static Resource findPgBinary(String resourceLocation) throws IOException {
        ...
        ClassLoader classLoader = CustomPostgresBinaryResolver.class.getClassLoader();
        List<URL> urls = Collections.list(classLoader.getResources(resourceLocation));
        Set<URL> urls_sets = new HashSet<URL>(urls);
